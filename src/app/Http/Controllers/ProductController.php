...
//        echo "<pre>"; print_r($category); die;
    ...
    public function todaysdealCreatePost(Product $product, Request $request)
    {
    ...
    public function todaysDealupdate(Product $product, Request $request)
    {
      echo "Ok";
      die();
        $product->id;
