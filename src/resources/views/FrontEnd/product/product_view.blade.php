            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-12">
                    <div class="Product__img">
                        <a href='{{ asset("Back/images/product/".$product->product_img) }}' data-lightbox="img">
                            <img src='{{ asset("Back/images/product/".$product->product_img) }}' data-lightbox="img" width="300px" alt="{{ $product->product_name }}">
                        </a>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 col-12">
