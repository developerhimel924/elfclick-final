...
<!-- Recommended Categories Section Start -->
    <section class="container animate__animated animate__fadeInUp">
        <div class="Recommended__categories__Section some_image_section">
            <div class="row">
              @forelse($bannersRecommanded as $ban)
              <div class="col-md-2 col-sm-4 col-4">
                <img src="{{ asset("Back/images/banner/".$ban->image) }}" alt="" class="some_row_image">
              </div>
            @empty
            @endforelse
            </div>
...
<!-- Recommended Categories Section Start -->
    ...
    <section class="container animate__animated animate__fadeInUp">
        ...
        <div class="recommended__container">
            @php
            $TodaysDeal = DB::table('todaysdeal')->where('status', 1)->limit(9)->get();
            @endphp
            <div class="row">
                @forelse($TodaysDeal as $pro)
                <div class="recommended__Items col-md-4 col-sm-6 col-12">
                    <a href="{{ route('todaysDealProducts',$pro->slug) }}" class="recommended__content">
                        <div class="recommendedImg">
                            <img src="{{ asset("Back/images/product/".$pro->product_img) }}" alt="">
                        </div>
                        <div class="recommended__items__details">
    ...
    <div class="container">
        <div class="homepageDescription">
            ...
            <h3>Online Shopping on elf-click.com – Get the best deals here!</h3>
