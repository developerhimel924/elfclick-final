    ...
    <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="offset-1 col-xl-10 col-md-10 col-sm-10 col-10">
                ...
                <form action="{{ route('todaysdealCreatePost') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="float" class="form-control @error('product_price') is-invalid @enderror" value="{{ old('product_price') }}" id="name" name="product_price">
                        @error('product_price')
                        <div class="alert alert-default-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="float" class="form-control @error('product_price_old') is-invalid @enderror" value="{{ old('product_price_old') }}" id="name" name="product_price_old">
