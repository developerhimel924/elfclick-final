...
Route::get('/todaysdeal', [TodaysdealController::class, 'TodaysdealList'])->name('TodaysdealList');
Route::get('/todaysdeal-create', [TodaysdealController::class, 'TodaysdealCreate'])->name('TodaysdealCreate');
Route::get('todaysdeals/active/{id}', [TodaysdealController::class, 'active'] )->name('todaysdeals_active');
Route::get('todaysdeals/inactive/{id}', [TodaysdealController::class, 'inactive'])->name('todaysdeals_inactive');
Route::get('todaysdeals/delete/{id}', [TodaysdealController::class, 'todaysdealDelete'])->name('todaysdealDelete');
Route::get('todaysdeals/todaysdealsEdit/{id}', [TodaysdealController::class, 'todaysdealsEdit'])->name('todaysdealsEdit');
Route::post('todaysdeals/todaysdealsUpdate/', [TodaysdealController::class, 'todaysdealsUpdate'])->name('todaysdealsUpdate');
...
Route::get('/privacy-policy', [PrivacyController::class, 'index'])->name('privacy-and-policy');
...
Route::get('/product-todays-deals-{slug}', [FrontEndController::class, 'todaysDealProducts'])->name('todaysDealProducts');
...
Route::get('/todays-deals', [FrontEndController::class, 'todaysDeals'])->name('todaysDeals');
...
//        Route::get('/list',[SectionController::class, 'index'])->name('section.index');
    ...
    Route::post('/product/todays-deal/post', [ProductController::class, 'todaysdealCreatePost'])->name('todaysdealCreatePost');
