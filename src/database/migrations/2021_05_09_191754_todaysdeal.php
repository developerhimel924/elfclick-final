...
class Todaysdeal extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
      Schema::create('todaysdeal', function (Blueprint $table) {
      $table->id();
      ...
      $table->double('product_price_old')->nullable();
    ...
    {
        Schema::dropIfExists('todaysdeal');
    }
}
